...
export let schedule = {
    ...
    movie2: {
        ...
        showtimes: {
            ...
            thu: ["7:30pm"],
            fri: ["4:00pm", "7:30pm"],
            sat: ["12:00pm", "2:45pm", "5:45pm", "7:30pm"],
            sun: ["12:00pm", "2:45pm", "5:45pm", "7:30pm"],
        },
    },
    ...
    movie4: {
        ...
        trailer: "https://www.youtube.com/embed/pGi3Bgn7U5U?autoplay=1",
        showtimes: {
            mon: [""],
            tue: ["7:30pm"],
            wed: [""],
    ...
    movie6: {
        ...
        showtimes: {
            ...
            thu: ["7:30pm"],
            fri: ["7:30pm"],
            sat: ["12:20pm", "1:50pm", "7:30pm"],
            sun: ["12:20pm", "1:50pm", "7:30pm"],
        },
    },
